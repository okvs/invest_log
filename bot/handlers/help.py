...
<b>📈 조회 · 리포트</b>
  ...
  <code>자산그래프</code> — 기록 첫날부터 일별 NAV 추이 PNG (<code>자산그래프 1개월</code>·<code>30일</code> = 최근 기간 총자산 윈도우)
  ...
  <code>담보</code> — 신용 담보비율((평가금+예수금)/융자) 시뮬레이션 · 하락률별 반대매매 HTML
  <code>융자</code> — 종목별 신용융자 잔액 동기화 (앱 잔고 `종목명 금액` 붙여넣기)
